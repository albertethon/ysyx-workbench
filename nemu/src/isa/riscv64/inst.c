 ...
 **/
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 01110 11", sllw   , R, R(dest) = SEXT(BITS(src1 << BITS(src2,4,0), 31, 0),31);printf("R(dest):%lx\tsrc1:%lx\tsrc2:%lx",R(dest),src1,src2));//x[rd] = sext((x[rs1] << x[rs2][4:0])[31:0])
