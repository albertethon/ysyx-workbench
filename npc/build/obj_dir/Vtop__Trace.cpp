...
void Vtop___024root__traceChgSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
            ...
            tracep->chgCData(oldp+443,(vlSelf->top__DOT____Vcellout__b2seg0__seg_out),7);
            tracep->chgCData(oldp+444,(vlSelf->top__DOT__b2seg0__DOT__i0__DOT__i0__DOT__lut_out),7);
            tracep->chgBit(oldp+445,(vlSelf->top__DOT__b2seg0__DOT__i0__DOT__i0__DOT__hit));
            tracep->chgCData(oldp+446,(vlSelf->top__DOT____Vcellout__b2seg1__seg_out),7);
            tracep->chgCData(oldp+447,(vlSelf->top__DOT__b2seg1__DOT__i0__DOT__i0__DOT__lut_out),7);
            tracep->chgBit(oldp+448,(vlSelf->top__DOT__b2seg1__DOT__i0__DOT__i0__DOT__hit));
            tracep->chgCData(oldp+449,(vlSelf->top__DOT____Vcellout__b2seg2__seg_out),7);
            tracep->chgCData(oldp+450,(vlSelf->top__DOT__b2seg2__DOT__i0__DOT__i0__DOT__lut_out),7);
            tracep->chgBit(oldp+451,(vlSelf->top__DOT__b2seg2__DOT__i0__DOT__i0__DOT__hit));
            tracep->chgCData(oldp+452,(vlSelf->top__DOT____Vcellout__b2seg3__seg_out),7);
            tracep->chgCData(oldp+453,(vlSelf->top__DOT__b2seg3__DOT__i0__DOT__i0__DOT__lut_out),7);
            tracep->chgBit(oldp+454,(vlSelf->top__DOT__b2seg3__DOT__i0__DOT__i0__DOT__hit));
            tracep->chgCData(oldp+455,((0xfU & (IData)(vlSelf->top__DOT__count))),4);
            tracep->chgCData(oldp+456,(vlSelf->top__DOT____Vcellout__b2seg4__seg_out),7);
            tracep->chgCData(oldp+457,(vlSelf->top__DOT__b2seg4__DOT__i0__DOT__i0__DOT__lut_out),7);
            tracep->chgBit(oldp+458,(vlSelf->top__DOT__b2seg4__DOT__i0__DOT__i0__DOT__hit));
            tracep->chgCData(oldp+459,((0xfU & ((IData)(vlSelf->top__DOT__count) 
                                                >> 4U))),4);
            tracep->chgCData(oldp+460,(vlSelf->top__DOT____Vcellout__b2seg5__seg_out),7);
            tracep->chgCData(oldp+461,(vlSelf->top__DOT__b2seg5__DOT__i0__DOT__i0__DOT__lut_out),7);
            tracep->chgBit(oldp+462,(vlSelf->top__DOT__b2seg5__DOT__i0__DOT__i0__DOT__hit));
        }
            ...
            tracep->chgSData(oldp+468,((((0x23U < (IData)(vlSelf->top__DOT__vgac__DOT__y_cnt)) 
                                         ...
                                         ? (0x3ffU 
                                            & ((IData)(vlSelf->top__DOT__vgac__DOT__y_cnt) 
                                               - (IData)(0x24U)))
                                         : 0U)),10);
            tracep->chgSData(oldp+469,(vlSelf->top__DOT__vgac__DOT__x_cnt),10);
            tracep->chgSData(oldp+470,(vlSelf->top__DOT__vgac__DOT__y_cnt),10);
            tracep->chgBit(oldp+471,(((0x90U < (IData)(vlSelf->top__DOT__vgac__DOT__x_cnt)) 
                                      & (0x310U >= (IData)(vlSelf->top__DOT__vgac__DOT__x_cnt)))));
            tracep->chgBit(oldp+472,(((0x23U < (IData)(vlSelf->top__DOT__vgac__DOT__y_cnt)) 
                                      & (0x203U >= (IData)(vlSelf->top__DOT__vgac__DOT__y_cnt)))));
        }
        tracep->chgBit(oldp+473,(vlSelf->clk));
        tracep->chgBit(oldp+474,(vlSelf->rst));
        tracep->chgBit(oldp+475,(vlSelf->clrn));
        tracep->chgBit(oldp+476,(vlSelf->ps2_clk));
        tracep->chgBit(oldp+477,(vlSelf->ps2_data));
        tracep->chgBit(oldp+478,(vlSelf->we));
        tracep->chgCData(oldp+479,(vlSelf->din),8);
        tracep->chgSData(oldp+480,(vlSelf->sw),16);
        tracep->chgCData(oldp+481,(vlSelf->btn),4);
        tracep->chgCData(oldp+482,(vlSelf->scancode),8);
        tracep->chgCData(oldp+483,(vlSelf->asciicode),8);
        tracep->chgBit(oldp+484,(vlSelf->ready));
        tracep->chgBit(oldp+485,(vlSelf->overflow));
        tracep->chgBit(oldp+486,(vlSelf->VGA_CLK));
        tracep->chgBit(oldp+487,(vlSelf->VGA_HSYNC));
        tracep->chgBit(oldp+488,(vlSelf->VGA_VSYNC));
        tracep->chgBit(oldp+489,(vlSelf->VGA_VALID));
        tracep->chgCData(oldp+490,(vlSelf->VGA_R),8);
        tracep->chgCData(oldp+491,(vlSelf->VGA_G),8);
        tracep->chgCData(oldp+492,(vlSelf->VGA_B),8);
        tracep->chgCData(oldp+493,(vlSelf->out),4);
        tracep->chgSData(oldp+494,(vlSelf->led),16);
        tracep->chgCData(oldp+495,(vlSelf->HEX0),8);
        tracep->chgCData(oldp+496,(vlSelf->HEX1),8);
        tracep->chgCData(oldp+497,(vlSelf->HEX2),8);
        tracep->chgCData(oldp+498,(vlSelf->HEX3),8);
        tracep->chgCData(oldp+499,(vlSelf->HEX4),8);
        tracep->chgCData(oldp+500,(vlSelf->HEX5),8);
        tracep->chgCData(oldp+501,(vlSelf->top__DOT__vram__DOT__key_ram
                                   [(((IData)(vlSelf->top__DOT__vgac__DOT__h_count_n) 
                                      << 7U) | (IData)(vlSelf->top__DOT__vgac__DOT__v_count_n))]),8);
        tracep->chgIData(oldp+502,(vlSelf->top__DOT__vga_data),24);
        tracep->chgBit(oldp+503,((1U & (~ (IData)(vlSelf->rst)))));
        tracep->chgCData(oldp+504,((0xfU & (IData)(vlSelf->scancode))),4);
        tracep->chgCData(oldp+505,((0xfU & ((IData)(vlSelf->scancode) 
                                            >> 4U))),4);
        tracep->chgCData(oldp+506,((0xfU & (IData)(vlSelf->asciicode))),4);
        tracep->chgCData(oldp+507,((0xfU & ((IData)(vlSelf->asciicode) 
                                            >> 4U))),4);
        tracep->chgSData(oldp+508,(vlSelf->top__DOT__asci2dot0__DOT__y_dot),12);
    }
}
