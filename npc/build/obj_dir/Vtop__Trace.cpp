...
void Vtop___024root__traceChgSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
            tracep->chgCData(oldp+463,(vlSelf->top__DOT__fmem0__DOT__test_font_mem
            ...
            tracep->chgSData(oldp+469,((((0x23U < (IData)(vlSelf->top__DOT__vgac__DOT__y_cnt)) 
                                         ...
                                         ? (0x3ffU 
                                            & ((IData)(vlSelf->top__DOT__vgac__DOT__y_cnt) 
                                               - (IData)(0x24U)))
                                         : 0U)),10);
            tracep->chgIData(oldp+470,(vlSelf->top__DOT__vga_data),24);
            tracep->chgSData(oldp+471,(vlSelf->top__DOT__asci2dot0__DOT__y_dot),12);
